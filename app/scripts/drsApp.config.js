...
config.$inject = ['$compileProvider', '$translateProvider', '$translateMessageFormatInterpolationProvider', 'localStorageServiceProvider'];

function config($compileProvider, $translateProvider, $translateMessageFormatInterpolationProvider, localStorageServiceProvider) {
